...
class ItemGridCustomer extends StatelessWidget {

  VoidCallback Func;
  bool IsAllProvice;
  List<ResultModelCustomerNew> Region=[];

  int index;


  ItemGridCustomer(this.Func, this.IsAllProvice, this.Region, this.index);
          ...
          Center(
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    Region[index].customerName.toString(),
