...
import 'ItemGridCityOneChoose.dart';

class MainItemFilterCityOneChoose extends StatefulWidget {
  ...
  MainItemFilterCityOneChoose(this.IsAllProvice,this.City, this.Func,this.Func2,this.sizetext);

  @override
  State<MainItemFilterCityOneChoose> createState() => _MainItemFilterState();
}

class _MainItemFilterState extends State<MainItemFilterCityOneChoose> {
