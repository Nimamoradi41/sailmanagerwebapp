...
class MainItemFilterRegion extends StatefulWidget {
  ...
  MainItemFilterRegion(this.IsAllProvice,this.Region, this.Func,this.Func2,this.sizetext);

  @override
  State<MainItemFilterRegion> createState() => _MainItemFilterState();
}

class _MainItemFilterState extends State<MainItemFilterRegion> {
