...
import 'ItemGridPathOneChoose.dart';

class MainItemFilterPathOneChoose extends StatefulWidget {
  ...
  MainItemFilterPathOneChoose(this.IsAllProvice,this.Path, this.Func,this.Func2,this.sizetext);

  @override
  State<MainItemFilterPathOneChoose> createState() => _MainItemFilterState();
}

class _MainItemFilterState extends State<MainItemFilterPathOneChoose> {
